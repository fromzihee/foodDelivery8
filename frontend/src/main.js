...
pluralCaseList.push( {plural: "orderManges", pascal: "OrderMange"} )

pluralCaseList.push( {plural: "bestMenus", pascal: "BestMenu"} )
pluralCaseList.push( {plural: "notificationLogs", pascal: "NotificationLog"} )

pluralCaseList.push( {plural: "orderSts", pascal: "OrderSts"} )
pluralCaseList.push( {plural: "deliveries", pascal: "Delivery"} )

pluralCaseList.push( {plural: "checkitems", pascal: "Checkitem"} )
